...
public class BpOrderDetail {
    ...
    public String getOrderrdesc() {
        return orderrdesc;
    }

    public void setOrderrdesc(String orderrdesc) {
        this.orderrdesc = orderrdesc;
    }

    public String getOrderrcode() {
        return orderrcode;
    }

    public void setOrderrcode(String orderrcode) {
        this.orderrcode = orderrcode;
    }
